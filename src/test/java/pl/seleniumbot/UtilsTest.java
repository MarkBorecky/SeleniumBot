...
public class UtilsTest {
    ...
    void shouldReadResourceFieldFromString() {
        String containerText = """
                ...
                <a href="/build.php?id=1" class="good level colorLayer gid1 buildingSlot1  level2"><div class="labelLayer">2</div></a>
                <a href="/build.php?id=2" class="good level colorLayer gid4 buildingSlot2  level2"><div class="labelLayer">2</div></a>
                <a href="/build.php?id=3" class="good level colorLayer gid1 buildingSlot3  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=4" class="good level colorLayer gid3 buildingSlot4  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=5" class="good level colorLayer gid2 buildingSlot5  level1"><div class="labelLayer">1</div></a>
                <a href="/build.php?id=6" class="good level colorLayer gid2 buildingSlot6  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=7" class="good level colorLayer gid3 buildingSlot7  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=8" class="good level colorLayer gid4 buildingSlot8  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=9" class="good level colorLayer gid4 buildingSlot9  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=10" class="good level colorLayer gid3 buildingSlot10  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=11" class="good level colorLayer gid3 buildingSlot11  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=12" class="good level colorLayer gid4 buildingSlot12  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=13" class="good level colorLayer gid4 buildingSlot13  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=14" class="good level colorLayer gid1 buildingSlot14  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=15" class="good level colorLayer gid4 buildingSlot15  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=16" class="good level colorLayer gid2 buildingSlot16  level2"><div class="labelLayer">2</div></a>
                <a href="/build.php?id=17" class="good level colorLayer gid1 buildingSlot17  level0"><div class="labelLayer"></div></a>
                <a href="/build.php?id=18" class="good level colorLayer gid2 buildingSlot18  level0"><div class="labelLayer"></div></a>        <svg class="resourceField resourceField3" viewBox="0 0 473 304">
                  ...
                  <path d="M223 109c-14.5 4.4-17.7 5.5-18.8 6.3-1.9 1.5-7.4 4.6-10.2 5.8-1.4.6-3.8 1.7-5.5 2.4-1.6.7-5 1.9-7.4 2.7-5.7 1.7-6.9 3.5-4.8 7.7 1.2 2.3 1.3 3.9.6 6.3-1.2 4.2-.3 6.7 2.6 7.4 2 .5 2.5 1.4 3.1 6 .7 5.6 3.4 10.4 6 10.4.8 0 2.2.9 3.1 2 1 1.1 2.9 2 4.3 2s4.8.9 7.6 1.9c3.1 1.2 10.2 2.4 18 3.1 7.1.6 16 1.5 19.7 2 8.1 1 10 .3 15.6-6.2 4-4.4 8-6.5 16.5-8.4 3.3-.8 4.1-1.4 4.8-4.1.5-1.8 1.7-3.4 2.8-3.8 2.4-.8 2.5-1.8.5-4.9-1.2-1.8-1.3-2.9-.5-5.2.8-1.9.8-3.5.1-4.9-.5-1.1-1.2-4.5-1.6-7.7-.6-5.4-.8-5.7-4.4-7.2-3.5-1.3-7.4-5-8.3-7.7-.2-.6-2.6-1.2-5.3-1.4-2.8-.1-5.7-.5-6.5-.8-1.6-.7-20.1-3.6-26-4.1-1.9-.2-4.6 0-6 .4z" onclick="window.location.href='/dorf2.php'"></path>
                   ...
                   \s
                """;
        MutableList<ResourceField> resources = ResourceFieldFactory.create(containerText);
        SoftAssertions.assertSoftly(soft -> {
            soft.assertThat(resources).hasSize(18);
            soft.assertThat(resources.select(res -> res.getType() == LUMBER)).hasSize(4);
            soft.assertThat(resources.select(res -> res.getType() == LUMBER)).containsExactlyInAnyOrder(
                    ResourceField.builder().type(LUMBER).level(2).id(1).build(),
                    ResourceField.builder().type(LUMBER).level(0).id(3).build(),
                    ResourceField.builder().type(LUMBER).level(0).id(14).build(),
                    ResourceField.builder().type(LUMBER).level(0).id(17).build()
            );
            soft.assertThat(resources.select(res -> res.getType() == IRON)).hasSize(4);
            soft.assertThat(resources.select(res -> res.getType() == IRON)).containsExactlyInAnyOrder(
                    ResourceField.builder().type(IRON).level(0).id(4).build(),
                    ResourceField.builder().type(IRON).level(0).id(7).build(),
                    ResourceField.builder().type(IRON).level(0).id(10).build(),
                    ResourceField.builder().type(IRON).level(0).id(11).build()
            );
            soft.assertThat(resources.select(res -> res.getType() == CLAY)).hasSize(4);
            soft.assertThat(resources.select(res -> res.getType() == CLAY)).containsExactlyInAnyOrder(
                    ResourceField.builder().type(CLAY).level(1).id(5).build(),
                    ResourceField.builder().type(CLAY).level(0).id(6).build(),
                    ResourceField.builder().type(CLAY).level(2).id(16).build(),
                    ResourceField.builder().type(CLAY).level(0).id(18).build()
            );
            soft.assertThat(resources.select(res -> res.getType() == CROP)).hasSize(6);
            soft.assertThat(resources.select(res -> res.getType() == CROP)).containsExactlyInAnyOrder(
                    ResourceField.builder().type(CROP).level(2).id(2).build(),
                    ResourceField.builder().type(CROP).level(0).id(8).build(),
                    ResourceField.builder().type(CROP).level(0).id(9).build(),
                    ResourceField.builder().type(CROP).level(0).id(12).build(),
                    ResourceField.builder().type(CROP).level(0).id(13).build(),
                    ResourceField.builder().type(CROP).level(0).id(15).build()
            );
        });
    }
}
